...
st.set_page_config(page_title="Parceiros - Comunidade Game", page_icon=":material/support_agent:", layout="centered", initial_sidebar_state="collapsed")
...
st.session_state.df_docs = partnerService.get_docs()
